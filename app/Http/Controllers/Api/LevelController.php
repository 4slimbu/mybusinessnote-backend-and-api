...
{
    protected  $levelFields = ['id', 'name', 'slug', 'meta_title', 'meta_description', 'icon', 'badge_icon', 'badge_message', 'content', 'tooltip_title', 'tooltip', 'template', 'is_active', 'is_down', 'down_message'];
    protected  $sectionFields = ['id', 'level_id', 'name', 'slug', 'meta_title', 'meta_description', 'icon', 'hover_icon', 'tooltip_title', 'tooltip', 'show_landing_page', 'template', 'is_active'];
