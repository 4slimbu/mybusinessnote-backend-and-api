...
class Level extends Model
{
    ...
    protected $fillable = ['name', 'slug', 'meta_title', 'meta_description', 'icon', 'badge_icon', 'badge_message', 'content', 'tooltip_title', 'tooltip', 'template', 'is_active', 'is_down', 'down_message'];
