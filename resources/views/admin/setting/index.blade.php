            ...
            <table class="table table-striped">
                ...
                @foreach ($data['rows'] as $item)
                    <tr>
                        ...
                        <td>
                            <div class="">
                                <a href="{{ route('admin.setting.edit', $item->id) }}" class="btn btn-sm btn-primary">Edit</a>
                                <form class="form-inline" method="POST" action="{{ route('admin.setting.destroy', $item->id) }}">
                                    {{ csrf_field() }}
                                    {{ method_field('DELETE') }}
